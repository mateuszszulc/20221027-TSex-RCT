/**
 *
 * Czasami potrzebne nam jest "zawężenie" używanego typu.
 * Zwłaszcza w momencie, kiedy stosujemy Unię typów, lub dana wartość może być niezdefiniowana (undefined)
 *
